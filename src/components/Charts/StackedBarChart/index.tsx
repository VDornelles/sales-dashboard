...
import { getStackedChartDataByYear } from "../../../utils/chartUtils";

// import { Container } from './styles';

const StackedBarChart: React.FC = () => {
  const [stackedChartData, setStackedChartData] = useState<IStackedBarChart[]>();
  const { selectedYear }: IDashboardContext = useContext(DashboardContext);

  useEffect(() => {
    setStackedChartData(getStackedChartDataByYear(selectedYear));
  }, [selectedYear]);
  ...
  const CustomIcon = (props: any) => {
    ...
    switch (payload.value) {
      case Products.BooksAndMagazines:
        return (
          <svg x={x - 7} y={y} width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      ...
      case Products.ClothingAndAccessories:
        return (
          <svg x={x - 7} y={y} width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path
              fill-rule="evenodd"
      ...
      case Products.ElectronicsAndAppliances:
        return (
          <svg x={x - 7} y={y} width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
